...
class TestOrdersLine:
    ...
    def test_when_creating_new_order_completed_for_all_time_counter_increases(self, driver, login, ingredient_1, ingredient_2):
        main_page = MainPage(driver)
        main_page.open(Urls.URL_SB)
        main_page.click_on_login_in_account_button()
        login_page = LoginPage(driver)
        ...
        main_page = MainPage(driver)
        main_page.click_on_orders_line_button()
        count_orders_before = main_page.get_counter_order_completed_for_all_time()
        ...
        main_page.click_on_close_button_order_pop_up_window()
        main_page.click_on_orders_line_button()
        count_orders_after = main_page.get_counter_order_completed_for_all_time()
